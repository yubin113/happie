...
#include <stddef.h>
#include "ssafy_msgs/msg/num__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c_message_initialization _init)
{
  ...
  (void) _init;
  ssafy_msgs__msg__Num__init(message_memory);
}

void Num__rosidl_typesupport_introspection_c__Num_fini_function(void * message_memory)
{
  ssafy_msgs__msg__Num__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Num__rosidl_typesupport_introspection_c__Num_message_member_array[3] = {
  {
    "num",  // name
    ...
    offsetof(ssafy_msgs__msg__Num, num),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ssafy_msgs__msg__Num, air),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ssafy_msgs__msg__Num, door),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ssafy_msgs, msg, Num)() {
