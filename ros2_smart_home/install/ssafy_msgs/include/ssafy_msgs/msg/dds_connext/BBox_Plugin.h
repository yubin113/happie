...
#ifndef BBox_Plugin_1013145143_h
#define BBox_Plugin_1013145143_h
...
namespace ssafy_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define BBox_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define BBox_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define BBox_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define BBox_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define BBox_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern BBox_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            BBox_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                BBox_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            BBox_Plugin_new(void);

            NDDSUSERDllExport extern void
            BBox_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* BBox_Plugin_1013145143_h */
