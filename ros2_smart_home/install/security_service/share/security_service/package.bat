...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\security_service\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\security_service\hook\ament_prefix_path.bat"
