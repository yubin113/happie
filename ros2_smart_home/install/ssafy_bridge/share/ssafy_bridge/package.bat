...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ssafy_bridge\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ssafy_bridge\hook\ament_prefix_path.bat"
