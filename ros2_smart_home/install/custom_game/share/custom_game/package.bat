...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\custom_game\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\custom_game\hook\ament_prefix_path.bat"
